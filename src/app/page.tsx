    ...
    <main className="min-h-screen bg-neutral-50 pb-28 text-neutral-900">
      ...
      <section className="py-10">
        <div className="mx-auto w-full max-w-5xl px-5">
          <div className="rounded-3xl border border-amber-100/70 bg-white/80 p-6 shadow-sm backdrop-blur md:p-8">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 md:items-center">
          <div>
                <div className="inline-flex items-center gap-2 rounded-full border border-amber-200/80 bg-gradient-to-r from-amber-50 via-white to-emerald-50 px-3 py-2 text-xs font-extrabold text-amber-900 shadow-sm">
